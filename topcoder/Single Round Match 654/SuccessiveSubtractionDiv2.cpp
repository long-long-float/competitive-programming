...
// CUT begin
ifstream data("SuccessiveSubtractionDiv2.sample");
...
bool do_test(vector<int> a, vector<int> p, vector<int> v, vector<int> __expected) {
    ...
    SuccessiveSubtraction *instance = new SuccessiveSubtraction();
...
int main(int argc, char *argv[]) {
    ...
    if (mainProcess) {
        cout << "SuccessiveSubtractionDiv2 (1000 Points)" << endl << endl;
    }
